<!--
 ...
 //////////////////////////////////////////////////////////////////////////////
-->
# Web Components Demo – yFiles for HTML
...
svg .node { fill: #19535f; }

With Shadow Root No Shadow Root

You can also uncheck the 'Shadow Root' option in the toolbar to see how the user-defined CSS affects the graph visualization.
