...
This demo shows how to bundle the yFiles for HTML library in a [rollup](https://rollupjs.org/) project.

The yFiles for HTML library is imported in the demo sources, so Rollup will add yFiles to `bundle.js`.
